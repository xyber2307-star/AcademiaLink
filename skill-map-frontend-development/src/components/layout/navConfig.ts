...
export const navByRole: Record<UserRole, NavSection[]> = {
  ...
  recruiter: [
    { items: [{ label: "Dashboard", to: "/recruiter", icon: LayoutDashboard }, { label: "Company Profile", to: "/recruiter/company", icon: Building2 }] },
  ...
  faculty: [
    { items: [{ label: "Dashboard", to: "/faculty", icon: LayoutDashboard }, { label: "Students", to: "/faculty/students", icon: Users }] },
  ...
  institution: [
    { items: [{ label: "Dashboard", to: "/institution", icon: LayoutDashboard }] },
  ...
  admin: [
    { items: [{ label: "Role Management", to: "/admin/roles", icon: Users }] },
    { title: "Management", items: [{ label: "User Roles", to: "/admin/roles", icon: Users }] },
  ],
