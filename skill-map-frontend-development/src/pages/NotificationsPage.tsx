        ...
        <div className="flex items-center gap-2">
          {unreadCount > 0 && (
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 text-xs font-semibold text-blue-600 hover:bg-blue-50 rounded-lg transition"
            >
            ...
            <div
              ...
              className={`p-4 rounded-2xl border transition flex items-start gap-4 cursor-pointer ${
                n.read
                  ...
                  : "bg-blue-50/40 border-blue-100 text-gray-900 font-medium shadow-sm"
              }`}
            >
              ...
              {!n.read && (
                <div className="w-2.5 h-2.5 rounded-full bg-blue-600 flex-shrink-0 mt-2"></div>
              )}
            </div>
          ))}
        </div>
